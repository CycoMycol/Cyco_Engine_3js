...
const DEFAULTS = {
  ...
  'Box Collider':          { type: 'Box Collider',         isTrigger: false, friction: 0.5, restitution: 0 },
  'Sphere Collider':       { type: 'Sphere Collider',      isTrigger: false, friction: 0.5, restitution: 0 },
  'Capsule Collider':      { type: 'Capsule Collider',     isTrigger: false },
  'Mesh Collider':         { type: 'Mesh Collider',        mode: 'convexHull', isTrigger: false },
  'Box Trigger':           { type: 'Box Trigger',          isTrigger: true },
  'Sphere Trigger':        { type: 'Sphere Trigger',       isTrigger: true },
  'Capsule Trigger':       { type: 'Capsule Trigger',      isTrigger: true },
